                ...
                int style )          //estilo do frame.
{
    ...
    if ( window->type == WT_OVERLAPPED)
    {
       ...
       createwDrawTitleBar ( (struct window_d *) window, 
            x, y,
            width, height, 
            1,
                     ...
                     unsigned long color ) 
{
    ...
    */
    ...
    {
        __w = (void *) createwCreateWindow2 ( WT_SIMPLE, status, view, (char *) windowname, 
                           x, y, width, height, 
                           (struct window_d *) pWindow, desktopid, clientcolor, color );      
...
draw_frame:
    ...
    if ( type == WT_OVERLAPPED || type == WT_EDITBOX )
    {
        ...
        createwDrawFrame ( (struct window_d *) __w, 
            x, y,
            width, height, 
            1 );  //style
    ...
    __w = (void *) createwCreateWindow2 ( type, status, view, (char *) windowname, 
                           x, y, width, height, 
                           (struct window_d *) pWindow, desktopid, clientcolor, color );      
